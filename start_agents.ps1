#!/usr/bin/env pwsh
# PlaybookPulse Agents Server Startup Script
# Quick launcher for the agents API server

Write-Host ""
Write-Host "═══════════════════════════════════════" -ForegroundColor Cyan
Write-Host "  PlaybookPulse Agents Server" -ForegroundColor Yellow
Write-Host "═══════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path ".\.env")) {
    Write-Host "⚠️  Warning: .env file not found in agents directory" -ForegroundColor Yellow
    Write-Host "   Server may fail without proper configuration" -ForegroundColor Yellow
    Write-Host ""
}

Write-Host "🚀 Starting agents server..." -ForegroundColor Green
Write-Host ""
